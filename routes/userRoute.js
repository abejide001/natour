...
const { getAllUsers, updateMe, deleteMe, getMe } = require("../controllers/UserController")
const { protectRoute } = require("../middlewares/protectRoute")
const { dontUpdatePassword } = require("../middlewares/userMiddleware")

userRouter.patch("/update-me", protectRoute, dontUpdatePassword, userImageUpload, resizeUserPhoto, updateMe)
