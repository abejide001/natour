    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "/api/v1/auth/update-password" : "/api/v1/users/update-me";
            _context.next = 4;
...
var stripe = Stripe("pk_test_EEcCmJQmGxIy0KPppuL3i38F00puePZync");
...
var mapBox = JSON.parse(JSON.stringify(document.getElementById("map")));
